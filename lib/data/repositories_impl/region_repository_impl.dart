...
class RegionRepositoryImpl implements RegionRepository {
  ...
  final ExecutorOfficeDao _officeDao;

  RegionRepositoryImpl(this._regionDao, this._officeDao);
  ...
  Future<void> updateExecutorOffices(int regionId, List<ExecutorOfficeEntity> offices) async {
    await _regionDao.updateExecutorOffices(regionId, offices);
  }

  @override
  Future<void> seedRegions(List<String> regionNames) async {
    final existing = await _regionDao.getAll();
    if (existing.isEmpty) {
